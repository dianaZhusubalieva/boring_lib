...
const Select = memo(({ value, options, onChange, placeholder = 'Select...' }: Props) => {
    const findLabelByValue = (value: any) => options.find((item) => item.value === value)?.label;
    ...
    return (
        <>
            ...
            >
                <div className={clsx("custom-select", { "custom-select__open": isOpen })}>
